...
If the word “bad” does not come after “not” or the words are not in the sentence, console.log the original 
sentence.*/

if (sentence.search("bad")>sentence.search("not") {
	console.log("This movie is bad!")
} else { 
sentence.search("bad") > sentence.search("not") {
